...
- Se normalizo `CommerceTrustCarousel` con una sola imagen fija de tienda, altura estable y copy mas claro para pagos, envios y soporte por WhatsApp, evitando saltos visuales o texto tapado al cambiar de slide.
