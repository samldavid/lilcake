...
- Se normalizo `CommerceTrustCarousel` con imagenes diferentes dentro de un mismo marco visual, altura estable, copy de pago mas claro y soporte por WhatsApp en verde, evitando saltos visuales o texto tapado al cambiar de slide.
