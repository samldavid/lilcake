...
- Normalized `CommerceTrustCarousel` to different images inside one fixed visual frame, stable card height, clearer payment copy, and green WhatsApp support styling so slide transitions do not resize or obscure text.
