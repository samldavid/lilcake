...
- Normalized `CommerceTrustCarousel` to a single fixed store image, stable card height, and clearer copy for payments, shipping, and WhatsApp support so slide transitions do not resize or obscure text.
